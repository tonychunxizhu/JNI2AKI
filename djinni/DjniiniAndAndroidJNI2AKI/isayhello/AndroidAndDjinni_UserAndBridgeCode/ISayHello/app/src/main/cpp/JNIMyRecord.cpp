...
namespace djinni_generated {
    ...
    auto JNIMyRecord::fromCpp(JNIEnv *jniEnv, const CppType &c) -> ::djinni::LocalRef<JniType> {
        ...
        auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                               ::djinni::get(::djinni::I32::fromCpp(
                                                                       jniEnv, c.id)),
                                                               ::djinni::get(
                                                                       ::djinni::String::fromCpp(
                                                                               jniEnv, c.name)),
                                                               ::djinni::get(
                                                                       ::djinni::String::fromCpp(
                                                                               jniEnv, c.project)),
                                                               ::djinni::get(
                                                                       ::djinni_generated::JNIGender::fromCpp(
                                                                               jniEnv, c.sex)))};
    ...
    auto JNIMyRecord::toCpp(JNIEnv *jniEnv, JniType j) -> CppType {
        ...
        return {::djinni::I32::toCpp(jniEnv, jniEnv->GetIntField(j, data.field_id)),
                ::djinni::String::toCpp(jniEnv,
                                        (jstring) jniEnv->GetObjectField(j, data.field_name)),
                ::djinni::String::toCpp(jniEnv,
                                        (jstring) jniEnv->GetObjectField(j, data.field_project)),
                ::djinni_generated::JNIGender::toCpp(jniEnv,
                                                     jniEnv->GetObjectField(j, data.field_sex))};
    }
